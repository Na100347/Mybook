...
class _LatestPageState extends State<LatestPage> {
  ...
  int _selectedTabIndex = 1; // Mới nhất được chọn

  @override
  void initState() {
    super.initState();
    _booksFuture = _bookService.searchBooks('latest books');
  }
            ...
            child: FutureBuilder<List<dynamic>>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.isEmpty) {
                  return Center(child: Text('Không tìm thấy sách mới nhất.', style: TextStyle(color: Colors.white)));
                }
